    ...
    <div class="sidebar_top">
        ...
        <div class="sidebar_content" id="sidebar">
            ...
            <?php include_once "sidebar_top_content.php"; ?>
              ...
              <h6> Page Links </h6>
              <p>
                  <a href="ParishInformation.php"> Parish Information </a>
                   <a href="#Chanel College">Chanel College</a><br />
                  <a href="#Mercy College">Mercy College</a><br />
                   <a href="#Scoil Chaitriona">Scoil Chaitriona</a><br />

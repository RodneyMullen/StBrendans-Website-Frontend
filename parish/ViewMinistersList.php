<div name="DownloadMinistersList" id="DownloadMinistersList" ></div>
<h2>Ministers of the Eucharist List</h2>
<h3>This month's Ministers of the Eucharist List available for download.</h3>
<table style="background-color:#003366; position:relative; left: 90px; width: 500px;" >
   <thead><tr><th></th></tr></thead>
   <tfoot><tr><th></th></tr></tfoot>
  <tbody>
<?php
$ff = "parish/ministerslist.php";
if (File_Exists($ff)) {
$fp = FOpen($ff,"r");
